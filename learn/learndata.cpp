...
LearnData::LearnData(std::array<Cell, 81> flat_board, std::vector<int> legal_moves, std::array<Cell, 9> grobal_board, bool is_first, std::string agent_name, int move, float state_value, std::array<float, 81> action_values, float result_value)
{
    this->flat_board = flat_board;
    this->legal_moves = legal_moves;
    this->grobal_board = grobal_board;
...
LearnData::LearnData(std::string json_string)
{
    ...
    this->grobal_board = json["grobal_board"].get<std::array<Cell, 9>>();
